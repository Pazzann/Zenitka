...
namespace Zenitka.Scripts.UI
{
	public partial class SettingsPanel3D : Control
	{
		public override void _Ready()
		{
			...
			var node15 =
				GetNode<LineEdit>("ColorRect/MarginContainer/VBoxContainer/2DDefaultTarget/HBoxContainer/LineEdit");
			...
			var node19 =
				GetNode<LineEdit>("ColorRect/MarginContainer/VBoxContainer/2DDefaultTarget/HBoxContainer3/LineEdit");
			...
			var node36 =
				GetNode<LineEdit>("ColorRect/MarginContainer/VBoxContainer/2DDefaultTarget/HBoxContainer5/LineEdit");
			node36.Text = Settings.Settings2D.DefaultTarget.AirResistance.ToString();

			var node21 =
				GetNode<LineEdit>("ColorRect/MarginContainer/VBoxContainer/2DRocketTarget/HBoxContainer/LineEdit");
			node21.Text = Settings.Settings2D.RocketTarget.RocketAcceleration.ToString();
			var node22 =
				GetNode<LineEdit>("ColorRect/MarginContainer/VBoxContainer/2DRocketTarget/HBoxContainer2/LineEdit");
			node22.Text = Settings.Settings2D.RocketTarget.MaxAngularVelocity.ToString();
			var node23 =
				GetNode<LineEdit>("ColorRect/MarginContainer/VBoxContainer/2DRocketTarget/HBoxContainer5/LineEdit");
			node23.Text = Settings.Settings2D.RocketTarget.DetonationDistance.ToString();
			var node24 =
				GetNode<LineEdit>("ColorRect/MarginContainer/VBoxContainer/2DRocketTarget/HBoxContainer6/LineEdit");
			node24.Text = Settings.Settings2D.RocketTarget.ShrapnelVelocity.ToString();
			var node25 =
				GetNode<LineEdit>("ColorRect/MarginContainer/VBoxContainer/2DRocketTarget/HBoxContainer7/LineEdit");
			var node26 =
				GetNode<LineEdit>("ColorRect/MarginContainer/VBoxContainer/2DRocketTarget/HBoxContainer7/LineEdit2");
...
/*
			...
			var node4 = GetNode<LineEdit>("ColorRect/MarginContainer/VBoxContainer/2DRocket/HBoxContainer/LineEdit");
			var node5 = GetNode<LineEdit>("ColorRect/MarginContainer/VBoxContainer/2DRocket/HBoxContainer/LineEdit2");
			Settings.Settings2D.RocketGun.ZenithDetectionCoordinates =
